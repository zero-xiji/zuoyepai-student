...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if([this_user_.THIS_USER_IS_LOGIN isEqualToString:@"1"])
    {
        ...
        _touxiang.image=[UIImage imageNamed:this_user_.THIS_STUDENT_USER_TOUXIANG];
        _l_userName.text=this_user_.THIS_STUDENT_USER_NAME;
...
- (IBAction)btn_logout:(id)sender {
    if([this_user_.THIS_USER_IS_LOGIN isEqual: @"1"])
    {
        ...
        [alert addAction:[UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            ...
            NSString *urlString = [NSString stringWithFormat:@"http://193.112.2.154:7079/SSHtet/logout?table=student&user_name=%@&password=%@",this_user_.THIS_STUDENT_USER_NAME,this_user_.THIS_STUDENT_USER_PASSWORD];
            ...
            //        NSURL *url =[NSURL URLWithString:[NSString stringWithFormat:@"http://193.112.2.154:7079/SSHtet/logout?table=student&user_name=%@&password=%@",this_user_.THIS_STUDENT_USER_NAME,this_user_.THIS_STUDENT_USER_PASSWORD]];
